%% This file calculates the difference between the observed data model estimates
...
% Find the difference between the observed and model estimates- we want to minimise this ?fitting_function'
