%% This file calculates the difference between the observed data and model estimates
...
% Find the difference between the observed data and model estimates-->we want to minimise this fitting_function'
